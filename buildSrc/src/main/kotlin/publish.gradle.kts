        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/programfoundation/player/")
                    ...
                    developers {
                        developer {
                            id.set("programfoundation")
                            name.set("programfoundation")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/programfoundation/player.git")
                        developerConnection.set("scm:git:ssh://github.com/programfoundation/player.git")
                        url.set("https://github.com/programfoundation/player/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/programfoundation/player/issues")
                    }
                }
            }
        }
